...
The top four predictors show low to moderate correlation with the response variable. Some are negatively correlated and others are positively correlated. According the [description]( https://www.rdocumentation.org/packages/AppliedPredictiveModeling/versions/1.1-6/topics/ChemicalManufacturingProcess) of the data:
...
The intuition that is potentially revealed about the predictors and their relationship with yield is how each predictor plays a small part in the yield. This would explain the need for a 27-step process. It also highlights the importance of selecting the appropriate biological material for the process.
