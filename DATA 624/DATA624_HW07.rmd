...
The intuition that is potentially revealed about the predictors and their relationship with yield is how each predictor plays a small part in the yield. This would explain the need for a 27-step process. It also highlights the importance of selecting the appropriate biological material for the pharmaceutical product.
