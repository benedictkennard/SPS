...
MARS models are [available] in several packages, but the most extensive implementation is in the [`earth` package](https://www.rdocumentation.org/packages/earth/versions/4.6.0/topics/earth). 
...
The [`knnreg` function](https://www.rdocumentation.org/packages/caret/versions/6.0-78/topics/knnreg) in the caret package fits the KNN regression model; train tunes the model over $K$.
