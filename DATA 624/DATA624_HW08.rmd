...
```{r warning=F, message=F, fig.align='center', cache=T}
set.seed(624)
fit5 <- gbm(y ~ ., simulated, distribution = "gaussian")
fit6 <- gbm(y ~ ., duplicated, distribution = "gaussian")
```
```{r warning=F, message=F, fig.align='center', cache=T}
set.seed(624)
