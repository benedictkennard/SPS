...
plot(Laws, main="Legislation on Immigration (Totals)")
lines(mov_avg, col=2)
...
plot(na.approx(RAHO), type="l", main="Race and Hispanic Origin (Totals)")
plot(na.approx(Proportions), type="l", main="Race and Hispanic Origin (Proportions)")
...
plot(na.approx(Proportions), type="l", main="Native and Foreign-born (Proportions)")
...
plot(na.approx(FBCO), type="l", main="Native and Foreign-born (Totals)")
plot(na.approx(Proportions), type="l", main="Native and Foreign-born (Proportions)")
...
```{r warning=F, message=F, fig.align='center', cache=TRUE}
plot(data698[, 19], ylab="Imm_All", main="Immigrant Visas (Total)")
Visas <- data698[, 18:21]
plot(window(Visas, start = 1981), main="Visas by Type (Total)")
```
...
plot(window(Enforce, start = 1925), main="Enforcement by Type (Total)")
```
...
plot(window(Economy[,1:8], start = 1987), main="GDP by Sector (Totals)")
plot(window(Economy[,9:16], start = 1987), main="GDP by Sector (Totals)")
GDP <- rowSums(Economy)
Proportions <- Economy / GDP
plot(window(Proportions[,1:8], start = 1987), main="GDP by Sector (Proportions)")
plot(window(Proportions[,9:16], start = 1987), main="GDP by Sector (Proportions)")
```
